...
public:
	...
	void emplace_array_front       (_Ty* arr, _Ty* end) { for (_Ty* i = arr; i != end; i++) emplace_front   (*i ); }
	void emplace_array_back        (_Ty* arr, _Ty* end) { for (_Ty* i = arr; i != end; i++) emplace_back    (*i ); }
	void push_array_front          (_Ty* arr, _Ty* end) { for (_Ty* i = arr; i != end; i++) push_front      (*i ); }
	void push_array_back           (_Ty* arr, _Ty* end) { for (_Ty* i = arr; i != end; i++) push_back       (*i ); }
