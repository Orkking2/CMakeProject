...
private:
	...
	LObj* find_first() { LObj* out; for (LObj* ptr = last_item_;  ptr; ptr = ptr->prev_) out = ptr; return out; }
	LObj* find_last () { LObj* out; for (LObj* ptr = first_item_; ptr; ptr = ptr->next_) out = ptr; return out; }
